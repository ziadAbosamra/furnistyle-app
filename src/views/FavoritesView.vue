<template>
  <div class="container py-5">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
      <div>
        <h2 class="fw-bold mb-1" style="color: var(--text-main, #2c2724);">
      ...
      <span class="badge fs-6 px-3 py-2 rounded-pill shadow-sm text-white" style="background-color: #2c2724;">
        {{ shopStore.favorites?.length || 0 }} Items
      </span>
    </div>
    ...
    <div v-else class="text-center py-5 rounded-4 p-4 bg-white shadow-sm border">
      ...
      <h4 class="fw-bold" style="color: var(--text-main, #2c2724);">No Favorites Yet</h4>
